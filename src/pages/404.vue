...
<template>
  ...
  >
    ...
    <div class="flex flex-col items-center gap-6 px-4 my-8">
      <NotFoundImage />
      <h1 class="va-h1 text-center sm:text-5xl text-4xl">
        Página não encontrada
      </h1>

      <p class="text-center">
        A página que você esta procurando pode ter sido removida ou mudou
        temporariamente.
      </p>

      <div class="flex flex-col sm:flex-row gap-4">
        <VaButton to="/">Ir para página principal</VaButton>
      </div>
    </div>
